# Predicting Car Selling Price: Project Overview
...
* mileage was converted to a numeric variable (kmpl was removed from string and then the remaining string was converted to a float)
* engine was converted to a numeric variable (CC was removed from string and then the remaining string was converted to an integer)
* max_power was converted to a numeric variable (bhp was removed from string and then the remaining string was converted to a float)
